...
final class WorkerListViewController: ListViewController {
    ...
    private func add() {
        ...
        let cdItem = CDWorker(context: viewContext)
        let viewModel = WorkerEditViewModel(viewContext: viewContext, cdItem: cdItem)
        
        let viewController = WorkerEditViewController()
